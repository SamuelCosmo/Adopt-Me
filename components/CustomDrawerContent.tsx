...
export default function CustomDrawerContent(props: any) {
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={{ backgroundColor: '#8B4513', flex: 1 }}>
      ...
      <View className='flex flex-row gap-[4px] justify-center items-center'>
        <Text style={{ color: 'white', fontSize: 12, textAlign: 'center' }}>Contact Us</Text>
        <Text style={{ color: 'white', fontSize: 12, textAlign: 'center' }}>|</Text>
        <Text style={{ color: 'white', fontSize: 12, textAlign: 'center' }}>Terms & Conditions.</Text>
      </View>
