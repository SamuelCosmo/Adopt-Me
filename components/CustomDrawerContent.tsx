...
export default function CustomDrawerContent(props: any) {
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={{ backgroundColor: '#8B4513', flex: 1 }}>
      <CatSvg />
      <DrawerItemList {...props} />
      <View className='flex flex-row gap-[4px] justify-center items-center' style={{ marginTop: 'auto' }}>
        <Text style={{ color: 'white', fontSize: 12, textAlign: 'center', marginTop: 'auto' }}>Contact Us</Text>
        <Text style={{ color: 'white', fontSize: 12, textAlign: 'center' }}>|</Text>
        <Text style={{ color: 'white', fontSize: 12, textAlign: 'center', marginTop: 'auto' }}>
          Terms & Conditions.
        </Text>
      </View>
...
function CatSvg() {
  ...
  return (
    <View className='flex flex-row justify-center items-center gap-[8px] m-[16px]'>
      {cat}
      <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold' }}>Adopt-Me!</Text>
      {cat}
    </View>
  )
}
